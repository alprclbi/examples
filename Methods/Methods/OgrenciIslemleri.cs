...
public class OgrenciIslemleri
{
    public void Gırıs()
    {
        Console.WriteLine("Bu bir geri donusu olmayan, parametresız bır metottur.");
    }
    public void Parametre(string ad)
    {
        Console.WriteLine($"Adınız: {ad}");
    }
    public string Gırıs(string soyad)
    {
        return soyad;
    }
}